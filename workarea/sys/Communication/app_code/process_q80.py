...
def start_payment(thisCommandId, thisCommandDetail, thisDeviceInfo):
    ...
    # 呼叫卡機
    _result = q80.start_payment(_devicePort, _paymentMethodCode, _totalPrice)
...
def send_message(thisCommandId, thisCommandDetail, thisDeviceInfo):
    ...
    _result = q80.send_with_return_sourceContent(_devicePort, _message)
