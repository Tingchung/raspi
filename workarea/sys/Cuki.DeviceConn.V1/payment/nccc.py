...
# Author        : Lia chen <liachen@monkit.tw>, Johnny Fang <johnnyfang@monkit.tw>
# Support Device Type : VX520 / DX350
...
# Func : send 
# Desc : 發送及接收資料
def send(thisPort, thisSendmessage, thisIsConnectTest):
    # 宣告物件
...
# Func : sendMessage 
# Desc : 接收&傳送電文內容
def sendMessage(thisPort, thisMessage):
     # 宣告物件
    objSerial = serial.Serial() 
    _Result = {
        "isSuccess": False,
